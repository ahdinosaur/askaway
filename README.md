[![Build Status](https://travis-ci.org/askaway/askaway.svg?branch=master)](https://travis-ci.org/askaway/askaway)
...
here's how to commit your work:

    git status (shows you what you've changed)
    git add <file_name> (says you intend to save the file)
    git commit -m "your message here" (saves your changes)

here's how to push your changes up to github (after you've committed):
